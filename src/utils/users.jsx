...
export function UsersLogic() {
  ...
  useEffect(() => {
    ...
    ApiRequest({
      url: 'https://burger-queen-api-zvby-dev.fl0.io/users',
      method: 'get',
    })
      .then((response) => {
  ...
  const handleConfirmEditClickUsers = () => {
    ...
    ApiRequest({
      url: `https://burger-queen-api-zvby-dev.fl0.io/users/${editingUserData.id}`,
      method: 'patch',
      body: updateUsers,
    })
      .then(() => {
  ...
  const handleConfirmDeleteClickUsers = (userId) => {
    ...
    ApiRequest({
      url: `https://burger-queen-api-zvby-dev.fl0.io/users/${userId}`,
      method: 'delete',
      body: body,
    })
      .then(() => {
