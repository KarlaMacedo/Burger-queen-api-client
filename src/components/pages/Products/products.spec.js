...
describe('Componente Products', () => {
    ...
    it('Debería cambiar el array selectedTypes cuando se hace clic en una casilla', () => {
      ...
      it('Redirige a la página de inicio de sesión cuando el token JWT ha expirado', async () => {
        ...
        mock.onGet('https://burger-queen-api-zvby-dev.fl0.io/products').reply(401, { data: 'jwt expired' });
    ...
    //     const mock = new MockAdapter(axios);
    //     mock.onGet('https://burger-queen-api-zvby-dev.fl0.io/products').reply(200, [
    ...
    //     const mock = new MockAdapter(axios);
    //     mock.onGet('https://burger-queen-api-zvby-dev.fl0.io/products').reply(200, { data: [{
    //         "id": 1,
